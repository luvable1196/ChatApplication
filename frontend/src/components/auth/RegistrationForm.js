...
import { User, Mail, Lock, Eye, EyeOff, UserPlus, Loader2, AlertCircle, ArrowLeft } from 'lucide-react';

const RegistrationForm = ({ onRegister, onSwitchToLogin, onBack }) => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center p-4">
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-2xl p-8 w-full max-w-md border border-white/20 relative">
        ...
        <div className="text-center mb-8 mt-4">
          <div className="bg-gradient-to-r from-purple-500 to-pink-600 rounded-full p-3 w-16 h-16 mx-auto mb-4 flex items-center justify-center">
            <UserPlus className="h-8 w-8 text-white" />
          </div>
          <h2 className="text-3xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent">
            Join ChatVerse
          </h2>
          <p className="text-gray-500 mt-2">Create your account to start connecting</p>
        </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 form-input"
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleChange}
                className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 bg-gray-50/50 form-input"
